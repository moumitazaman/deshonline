    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            ...
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">My Team List</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                  ...
                  <table id="datatable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        <a href="{{ route('backend.team.view', $seller->id) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
