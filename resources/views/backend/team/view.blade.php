                ...
                <hr>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="first_name" readonly id="first_name" value="{{$seller->first_name}}" placeholder="first name" title="enter your first name if any.">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="last_name"><h4>Last name</h4></label>
                              <input type="text" class="form-control" name="last_name" readonly id="last_name" value="{{$seller->last_name}}" placeholder="last name" title="enter your last name if any.">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="phone" readonly value="{{$seller->phone}}" id="phone" placeholder="enter phone" title="enter your phone number if any.">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="email" class="form-control" name="email"  readonly id="email" value="{{$seller->email}}" placeholder="you@email.com" title="enter your email.">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" name="address" class="form-control" readonly  id="location" value="{{$seller->address}}" placeholder="somewhere" title="enter a location">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" id="location" readonly  name="city" value="{{$seller->city}}" placeholder="somewhere" title="enter a location">
                          </div>
                      </div>
