        ...
        <div class="content">
          <div class="container-fluid">
            <div class="card card-default">
              <!-- form -->
              <form action="{{ route('backend.customer.perm', $id) }}" id="sales_info" method="POST" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                    <div class="col-md-6 offset-md-3">
                      ...
                      ?>
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"  value="{{ $customer->first_name }}">
                        @error('name')
                      ...
                      <div class="form-group">
                        <label for="name">Refference Id</label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="ref_id">
