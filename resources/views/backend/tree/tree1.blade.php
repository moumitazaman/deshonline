    ...
    <div class="content-wrapper">
        ...
        foreach($rights as $rths){
                  ...
                  ?>  
                    <ul>
		<li>
						<a href="{{ route('backend.tree.index',$me->seller_id) }}"><strong>Name:</strong> {{$me->first_name}} {{$me->last_name}} <br><strong>Seller ID:</strong> {{$id}}<br><strong>PCN:</strong>{{$me->pcn}}<br><strong>Designation: <?php if($me->grade){ echo "MSP";}?></strong>{{$me->grade}}<br><strong>Total Matching:</strong>{{$me->matches}}<br><strong>Team A Carry:</strong>{{$totalA}}<br><strong>Team B Carry:</strong>{{$totalB}}<br><strong>Refference ID:</strong>{{$me->ref_id}}</a>
<?php 
$totalcarryA=0;
                      $totalcarryB=0;
                      $totalcarrytwoA=0;
...
?>
        ...
        foreach($three as $th){
			    ...
			    ?>
				<li>
				    <a href="{{ route('backend.tree.index',$levelone1->seller_id) }}"><strong>Name:</strong> {{$levelone1->first_name}} {{$levelone1->last_name}} <br><strong>Seller ID:</strong> {{$levelone1->seller_id}}<br><strong>PCN:</strong>{{$levelone1->pcn}}<br><strong>Designation: <?php if($levelone1->grade){ echo "MSP";}?></strong>{{$levelone1->grade}}<br><strong>Total Matching:</strong>{{$levelone1->matches}}<br><strong>Team A Carry:{{$totalcarryA}}</strong><br><strong>Team B Carry:</strong>{{$totalcarryB}}<br><strong>Refference ID:</strong>{{$levelone1->ref_id}}</a>
					<ul>
					    <?php 
...
<a href="{{ route('backend.tree.index',$leveltwo1->seller_id) }}"><strong>Name:</strong> {{$leveltwo1->first_name}} {{$leveltwo1->last_name}} <br><strong>Seller ID:</strong> {{$leveltwo1->seller_id}}<br><strong>PCN:</strong>{{$leveltwo1->pcn}}<br><strong>Designation:<?php if($leveltwo1->grade){ echo "MSP";}?></strong>{{$leveltwo1->grade}}<br><strong>Total Matching:</strong>{{$leveltwo1->matches}}<br><strong>Team A Carry:</strong>{{$totalcarrytwoA}}<br><strong>Team B Carry:</strong>{{$totalcarrytwoB}}<br><strong>Refference ID:</strong>{{$leveltwo1->ref_id}}</a>
