...
<html lang="en">
<head>
<title>DeshOnline @yield('title')</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Desh shop project">
...
<div class="user_icon"><img src="{{ asset('frontend/images/user.svg')}}" alt=""></div>
								...
								@else
								<div><a href="{{ url('/login') }}">Sign in</a><a href="{{ url('/adminregisterform') }}">Want to become a Seller?</a></div>
