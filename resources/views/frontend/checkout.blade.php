                            ...
                            <article class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group  col-md-6">
                                        ...
                                        <input type="text" value="{{ auth()->user()->phone }}" class="form-control" name="phone_number">
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-4">
                                <button type="submit" class="subscribe btn btn-success pointer btn-lg btn-block">Place Order</button>
                            </div>
                        </div>
                    </div>
                </div>
